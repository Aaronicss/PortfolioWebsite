...
const Hero = () => {
    return (
        <div
            ...
            className="p-20 bg-cover bg-center w-full flex items-center justify-between px-70"
        >
            <div className=""><img src={face} className="rounded-full border-4 border-[#FFC300]"></img></div>
            <ul>
